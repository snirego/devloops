...
const navigation = {
  product: [
    ...
    { name: "Roadmap", href: "https://app.devloops.io/kan/roadmap" },
  ...
  resources: [
    ...
    { name: "Self-hosting", href: "https://github.com/kanbn/kan" },
    { name: "FAQ", href: "#faq" },
  ],
  company: [
    ...
    { name: "OSS Friends", href: "https://app.devloops.io/oss-friends" },
  ],
  legal: [
    { name: "Terms", href: "https://app.devloops.io/terms" },
    { name: "Privacy", href: "https://app.devloops.io/privacy" },
    { name: "License (AGPL-3.0)", href: "https://github.com/kanbn/kan?tab=AGPL-3.0-1-ov-file" },
  ],
};
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="col-span-2 sm:col-span-4 lg:col-span-1">
            ...
            <p className="mt-2 max-w-xs text-sm text-light-800 dark:text-dark-800">
              The open-source project management platform for teams that ship fast.
            </p>
