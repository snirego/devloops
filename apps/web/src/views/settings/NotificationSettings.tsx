      ...
      <div className="mb-8 border-t border-light-300 dark:border-dark-300">
        ...
        <div className="flex items-center justify-between rounded-lg border border-light-300 px-4 py-3 dark:border-dark-300">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 ${
              settings.soundEnabled ? "bg-brand-500" : "bg-gray-300 dark:bg-dark-400"
            }`}
          >
            <span
        ...
        <div className="mt-4 rounded-lg border border-light-300 px-4 py-3 dark:border-dark-300">
          ...
          <input
            ...
            className="mt-2 h-2 w-full cursor-pointer appearance-none rounded-full bg-light-200 accent-brand-500 disabled:cursor-not-allowed disabled:opacity-40 dark:bg-dark-300"
          />
        </div>
